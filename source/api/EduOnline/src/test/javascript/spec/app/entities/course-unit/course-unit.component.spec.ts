...
import { CourseUnitComponent } from 'app/entities/course-unit/course-unit.component';
...
describe('Component Tests', () => {
  describe('CourseUnit Management Component', () => {
    let comp: CourseUnitComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseUnitComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseUnits && comp.courseUnits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
