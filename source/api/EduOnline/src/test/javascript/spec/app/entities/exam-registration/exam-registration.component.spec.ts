...
import { ExamRegistrationComponent } from 'app/entities/exam-registration/exam-registration.component';
...
describe('Component Tests', () => {
  describe('ExamRegistration Management Component', () => {
    let comp: ExamRegistrationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExamRegistrationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.examRegistrations && comp.examRegistrations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
