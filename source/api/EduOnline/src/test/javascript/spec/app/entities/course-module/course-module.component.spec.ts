...
import { CourseModuleComponent } from 'app/entities/course-module/course-module.component';
...
describe('Component Tests', () => {
  describe('CourseModule Management Component', () => {
    let comp: CourseModuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourseModuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseModules && comp.courseModules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
