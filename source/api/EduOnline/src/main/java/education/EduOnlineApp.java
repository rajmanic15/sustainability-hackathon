...
import education.config.DefaultProfileUtil;
...
@OpenAPIDefinition(
    info = @Info(
        title = "eduOnline",
        version = "0.0",
        description = "eduOnline API"
    )
)
public class EduOnlineApp {

    private static final Logger log = LoggerFactory.getLogger(EduOnlineApp.class);

    /**
     * Initializes EduOnlineApp.
     * <p>
