...
export class ExamComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.examService
      ...
      .subscribe(
        (res: HttpResponse<IExam[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInExams(): void {
    this.eventSubscriber = this.eventManager.subscribe('examListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IExam[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
